...
import { MessageCircle, Terminal, AlertTriangle, Sparkles, Speech } from 'lucide-react';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      try {
        ...
        setNaturalLanguageAnswer(data.naturalLanguageExplanation || ''); // Set the natural language answer if available
    ...
    <section aria-labelledby="sql-chatbot-title" className="mt-8">
      ...
      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
        <CardHeader>
          ...
          <CardDescription>
            Ask a question in natural language, and the AI will translate it into an SQL query and provide an explanation.
          </CardDescription>
        </CardHeader>
      ...
      {naturalLanguageAnswer && (
        <Card className="mt-6">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">{naturalLanguageAnswer}</p>
          </CardContent>
        </Card>
      )}
    </section>
